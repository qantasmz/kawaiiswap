var Settings = {
	...
	PROXY : 'http://qanta.jp/',
	API_KEY : 'izbKNOiX5hdW0yN6gPTFXut5v',
	API_SECRET : 'Dl5GNMHSZq5ufgRuje0cL8glHRA2PIHkInSIp5QQiI7NxqXjDo',
	ACCESS_TOKEN : null,
...
var URL = {
	...
	make : function(page, params) {
		...
		params['page'] = page;
		var url = URL.CHROME_BASE + "newtab.html?" + QueryString.encode(params);
		return url;
	},
